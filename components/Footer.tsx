...
export default function Footer() {
    ...
    const footerLinks: FooterLinks = {
        ...
        Resources: [
            { name: 'GitHub', href: 'https://github.com/aakash4dev/MarketCompassZ', external: true },
            { name: 'GenAI Hackathon', href: 'https://www.commudle.com/communities/tensorflow-delhi/events/genai-hackathon-delhi', external: true },
        ],
    };
